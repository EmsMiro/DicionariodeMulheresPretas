function carregaDicionario () { 
    ...
    for (let bio in biografias) {
        content.innerHTML += `
            <div class="cards">
                <img class="img-section" src="${biografias[bio].imagem}">
                <details class="details-cards">
                    <summary class="summary-cards">${biografias[bio].nome}</summary>
                        <p class="paragraph-cards">${biografias[bio].descricao}</p>
                    <blockquote class="blockquote-cards">
